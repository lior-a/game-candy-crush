...
const Game = ({setVisibleScreen, setScore, score, setScoreBoard}) => {
    ...
    const checkForColumnOfThree = () => {
      for (let a = 0; a <= 47; a++) {
          const columnOfThree = [a, a+width, a + width * 2];
          const decidedColor = currentColorBoard[a];
          const isBlank = currentColorBoard[a] === blankCandy;
    ...
    const dragEnd = (e) => {
      ...
      // console.log('squareBeingDraggedId: ', squareBeingDraggedId, 'squareBeingReplacedId: ' ,  squareBeingReplacedId)
    ...
    // console.log('setVisibleScreen: ' , visibleScreen)
    // console.log('setIsGamerOver: ' ,isGameOver)
    ...
    return (
        <div className="game-wrapper">
            ...
            <ClockCounter setIsGamerOver={setIsGamerOver} />
            </div>
